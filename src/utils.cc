...
tuple<string, string> splitUrl(const string &url) {
  size_t start = 0;
...
static const size_t kRetainedPrefixLength =
    kMaxLength - kInternalPaddingLength - kRetainedSuffixLength;
bool shouldTruncate(const string &str) { return str.size() > kMaxLength; }
