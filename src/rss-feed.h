...
private:
   ...
   * implementation of parse() involved networking code, it's not clear what the
   * semantics of a deep copy really should be.  By deleting these two items, we
   * force all clients of the RSSFeed class to pass instances around by
   * reference or by addresses.
   */
